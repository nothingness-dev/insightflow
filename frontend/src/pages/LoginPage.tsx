      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-blue-600 px-8 py-8 text-center">
            ...
            <h1 className="text-xl font-bold text-white">سامانه نظرسنجی</h1>
            <p className="text-blue-200 text-sm mt-1">برای ادامه وارد شوید</p>
          </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          سامانه نظرسنجی سازمانی — محرمانه و امن
        </p>
      </motion.div>
    </div>
  );
