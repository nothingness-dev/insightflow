                      ...
                      {question.has_score && (
                        <label className="flex items-center gap-2 text-xs text-gray-500 mt-3">
                          <input
                            ...
                            onChange={(e) =>
                              updateQuestion(index, {
                                score_required: e.target.checked,
                              })
                            }
                          />
                      ...
                      {question.has_emoji && (
                        <label className="flex items-center gap-2 text-xs text-gray-500 mt-3">
                          <input
                            ...
                            onChange={(e) =>
                              updateQuestion(index, {
                                emoji_required: e.target.checked,
                              })
                            }
                          />
                      ...
                      {question.has_comment && (
                        <label className="flex items-center gap-2 text-xs text-gray-500 mt-3">
                          <input
                            ...
                            onChange={(e) =>
                              updateQuestion(index, {
                                comment_required: e.target.checked,
                              })
                            }
                          />
