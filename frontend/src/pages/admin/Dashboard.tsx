...
function StatCard({
  ...
  return (
    <div className="card p-3 sm:p-5 flex items-center gap-3 sm:gap-4">
      ...
      >
        <span
          style={{ color: isDark ? darkIconColor || iconColor : iconColor }}
        >
          {icon}
        </span>
      </div>
    ...
    <div className="responsive-page">
      ...
      <div className="card">
        ...
        {recent_surveys.length === 0 ? (
          <div className="px-4 sm:px-6 py-10 text-center text-gray-400 text-sm">
          ...
          <div className="divide-y divide-gray-50">
            {recent_surveys.map((survey: Survey) => (
              <div
                key={survey.id}
                className="px-4 sm:px-6 py-4 flex flex-col min-[420px]:flex-row min-[420px]:items-center min-[420px]:justify-between gap-3 hover:bg-gray-50 transition-colors"
              >
